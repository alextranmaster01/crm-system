...
- hãy sửa lỗi sau: 1/ Tab “Báo giá”,BẢNG REVIEW phần total price ở cuối bảng không hiện tổng của Unit price VND và Total price VND, hãy giải quyết triệt để vấn đề này, đừng để lỗi lặp lại, và không để bị lỗi: "Syntax error"
