    ...
    with ti:
        ...
        if up_i and st.button("🚀 CẬP NHẬT IMPORT DATA"):
            try:
                ...
                st.error(f"Lỗi Import: {e}")
# =============================================================================
# --- TAB 7: PROJECT MANAGEMENT (SỬA LỖI API & CHỌN NGÀY QUA LỊCH) ---
# =============================================================================
with t7:
    # --- 1. TẢI DỮ LIỆU ---
    ...
    with c_head2:
        with st.popover("➕ TẠO DỰ ÁN MỚI", use_container_width=True):
            ...
            p_start_d = col_d1.date_input("Ngày Bắt Đầu") # Widget lịch mặc định
        ...
        if not df_final_view.empty:
            ...
            with t_tasks:
                ...
                with col_g2:
                    ...
                    # Fix định dạng ngày tháng để quyển lịch hiện đúng
                    ...
                    ed_tasks = st.data_editor(df_t_ed, num_rows="dynamic", use_container_width=True, hide_index=True, 
                        column_config={
                            "start_date": st.column_config.DateColumn("Bắt đầu", format="DD/MM/YYYY"), # Hiện quyển lịch chọn ngày
